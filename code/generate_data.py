...
root_path="D:/学术相关/基因调控相关文献/math_thesis-master_代码/"
def read_data(data_id_list):
    ...
    for i in tqdm.tqdm(data_id_list):
        try:
            ...
            with open(root_path+f'feature_engineering/data/{features_file}/sc_features_{i}.pkl', 'rb') as f:
                sc_features = pickle.load(f)
            with open(root_path+f'feature_engineering/data/samples/label_{i}.pkl', 'rb') as f:
...
# i=7
# with open(root_path+'feature_engineering/data/x_train{}.pkl'.format(i), 'wb') as f:
#     pickle.dump(x_train, f)
# with open(root_path+'feature_engineering/data/y_train{}.pkl'.format(i), 'wb') as f:
#     pickle.dump(y_train, f)
# with open(root_path+'feature_engineering/data/x_test{}.pkl'.format(i), 'wb') as f:
#     pickle.dump(x_test, f)
# with open(root_path+'feature_engineering/data/y_test{}.pkl'.format(i), 'wb') as f:
#     pickle.dump(y_test, f)
#
# x_train.head(100).to_csv(root_path+'feature_engineering/data/x_train(sample).csv', float_format='%.5g')
# y_train.head(100).to_csv(root_path+'feature_engineering/data/y_train(sample).csv', float_format='%.5g')
x_all, y_all, _ = read_data(whole_data)
i=8
with open(root_path+'feature_engineering/data/x_train{}.pkl'.format(i), 'wb') as f:
    pickle.dump(x_all, f)
with open(root_path+'feature_engineering/data/y_train{}.pkl'.format(i), 'wb') as f:
